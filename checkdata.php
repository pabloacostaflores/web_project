...
<br>';
	...
	echo "Delegacion/Municipio: ".$_SESSION["delegacion"]."</br>";
	echo "Calle: ".$_SESSION["calle"]."</br>";
	echo "Colonia: ".$_SESSION["colonia"]."</br>";
	echo "CP: ".$_SESSION["codigoP"]."</br>";
	echo "Telefono de casa: ".$_SESSION["tele_casa"]."</br>";
	echo "Telefono celular: ".$_SESSION["num_telefono"]."</br>";	
	...
	echo "Opcion: ".$_SESSION["opcion"]."</br>";
